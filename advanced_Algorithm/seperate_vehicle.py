...
'''This step is to seperate every vehicle's data and write them into a seperated CSV file
            ...
            with open(newpath, 'w', newline ='') as fnew:    #use 'w' for writing str and newline='' for deleting extra idle row
                ...
                for row_v in r_vehicle:
                    ...
                    if row_v[0] == vehicleid:
                        ...
                        if len(row_v) == 10:
                            w_vehicle.writerow([row_v[0], row_v[1], row_v[2], row_v[3],row_v[4], row_v[5], row_v[6], row_v[7], row_v[8], row_v[9]])
